...
# Database configuration (NHẬP MẬT KHẨU)
db_config = {
    "host": "localhost",
    "user": "root",
    "password": "@sophie.mysql",
    "database": "airportdb",
    "allow_local_infile": True,
}

# THAY ĐỐI ĐƯỜNG DẪN Ở ĐÂY
tsv_directory = "D:/airport-db-trial"
...
def extract_table_name(filename):
    """Trích xuất tên bảng từ tên file, loại bỏ đuôi mở rộng và các ký tự số."""
